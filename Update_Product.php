...
////////////	
 ...
 <!--Form -->
		...
		<tr> <td>
		<br>
           <form action="Update_Product.php" method="postr">
      ...
      <form action="Update_Product.php" method="post">
	     ...
	     SET ContactName ________ <input type="text" name="ProductIDss" placeholder="Value To update"><br><br>
           ProductID <input type="text" name="ProductIDs" placeholder="Value To update"><br><br>
		   PName <input type="text" name="PNames" placeholder="Value To update"><br><br>
		   Description <input type="text" name="Descriptions" placeholder="Value To update"><br><br>
		   Price <input type="text" name="Prices" placeholder="Value To update"><br><br>
		   Stock <input type="text" name="Stocks" placeholder="Value To update"><br><br>
                ...
                <?php
                	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	               {
					...
					$sqlq1 = "insert into product (`ProductID`, `PName`, `Description`, `Price`, `Stock`) 
					 ...
					 $sqlq2 = "DELETE FROM `product` WHERE CONCAT(`ProductID`, `Pname`, `Description`, `Price`, `Stock`) LIKE '%".$varN6."%'";
